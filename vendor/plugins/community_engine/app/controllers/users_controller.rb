class UsersController < BaseController
  ...
  before_filter :login_required, :only => [:edit, :edit_account, :update, :welcome_photo, :welcome_about, 
                                          ...
                                          :toggle_featured, :toggle_admin_powers_on, :toggle_admin_powers_off, :edit_pro_details, :update_pro_details, :dashboard, :deactivate]
  before_filter :find_user, :only => [:edit, :edit_pro_details, :show, :update, :destroy, :statistics, :deactivate, :search ]
  ...
  before_filter :admin_required, :only => [:assume, :destroy, :featured, :toggle_featured, :toggle_moderator, :toggle_admin_powers_on, :toggle_admin_powers_off]
