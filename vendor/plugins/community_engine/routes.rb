...
ad_stats '/ad_stats', :controller => 'users', :action => 'ad_stats'
...
sent 'requests/sent', :controller => 'sponsor_stats', :action => 'sent'
accepted 'requests/accepted', :controller => 'sponsor_stats', :action => 'accepted'
denied 'requests/denied', :controller => 'sponsor_stats', :action => 'denied'
stats 'statictics', :controller => 'sponsor_stats', :action => 'statistics'
...
sponsors '/sponsors', :controller => 'sponsors', :action => 'index'
sponsors '/sponsors/showaddress', :controller => 'sponsors', :action => 'showaddress'
sponsors '/sponsors/sponsor_users', :controller => 'sponsors', :action => 'sponsor_users'
sponsors '/sponsors/sponsor_this_user', :controller => 'sponsors', :action => 'sponsor_this_user'
sponsors '/sponsors/sponsor_this_team', :controller => 'sponsors', :action => 'sponsor_this_team'
...
resources :users, :member_path => '/:id', :nested_member_path => '/:user_id', :member => { 
    ...
    :toggle_featured => :put,
    :toggle_admin_powers_on => :put,
    :toggle_admin_powers_off => :put,
